...
function akismet_admin_main()
{
    ...
    $renderer = Zikula_View::getInstance('akismet', false);
...
function akismet_admin_modifyconfig()
{
    ...
    $renderer->assign(ModUtil::getVar('akismet'));
...
function akismet_admin_updateconfig()
{
    ...
    if (!SecurityUtil::confirmAuthKey()) {
        return LogUtil::registerAuthidError (ModUtil::url('Bad_Behaviour', 'admin'));
    }
    ...
    if (!ModUtil::apiFunc('akismet', 'user', 'verifykey', array('apikey' => $apikey))) {
        ...
        ModUtil::setVar('akismet', 'apikeyvalid', true);
    }

    // set our new values
    ModUtil::setVar('akismet', 'enable', $enable);
    ModUtil::setVar('akismet', 'apikey', $apikey);

    // the module configuration has been updated successfuly
    LogUtil::registerStatus (__('Done! Module configuration updated.', $dom));

    // Let any other modules know that the modules configuration has been updated
    ModUtil::callHooks('module', 'updateconfig', 'akismet', array('module' => 'akismet'));
